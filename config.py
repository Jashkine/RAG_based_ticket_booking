...
JSON_SCHEMA =  {
        ...
        "departureTime": "Filter buses departing after this date and time (e.g., '2025-12-15 22:45:00')",
        "arrivalTime": "Filter buses arriving before this data and time (e.g., '2025-12-16 07:47:00')",
...
PARAMETER_FIELD_MAP = {
    ...
    "isLiveTrackingAvailable": ("isLiveTrackingAvailable", "Live Tracking"),
    "isMticketEnabled": ("isMticketEnabled", "M-Ticket"),
